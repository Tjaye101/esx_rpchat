...
Citizen.CreateThread(function()
	...
	TriggerEvent('chat:addSuggestion', '/insta',  _U('insta_help'),  {{name = _U('generic_argument_name'), help = _U('generic_argument_help')}})
...
AddEventHandler('onResourceStop', function(resource)
	if resource == GetCurrentResourceName() then
		...
		TriggerEvent('chat:removeSuggestion', '/insta')
